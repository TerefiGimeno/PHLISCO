...
# gap fill
#multiplicar el daily transp del 6 de mayo por los dias que ha pasado esa planta transpirando el 3 mayo.
...
transp$weight_kg <- ifelse(is.na(transp$weight_kg) & transp$date == as.Date("2021-06-06")
                           & transp$timing == "1_before watering",
